...
function Tplayer(Element, src, poster, server, videoid) {
    ...
    window.onload = function() {
        ...
        function danmutime() {
            ...
            if (tplayer.nowdata.length) {
                for (var i = 0; i < tplayer.nowdata.length; i++) {
                	if(tplayer.nowdata[i]){
	                    if (tplayer.nowdata[i].time == parseInt(tplayer.Element.currentTime * 10)) {  
