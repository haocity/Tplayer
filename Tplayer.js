...
function Tplayer(Element, src, poster, server, videoid, videotype) {
    ...
    tplayer.ele.alltime_phone= $c(".tp-control-alltime-phone")[0];
    ...
    function getallvideotime() {
        ...
        if (!time) {
            ...
            tplayer.ele.alltime_phone.innerHTML ='&nbsp;/&nbsp;'+getvideotime(tplayer.alltime).m + ":" + getvideotime(tplayer.alltime).s;
        }
    }
    getallvideotime();
    //音量调节
    tplayer.ele.tp_syk_range.addEventListener("input", function() {
