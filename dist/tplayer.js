        ...
        value: function init() {
            ...
            this.send = function (text, color, wz, me, user, size) {
                ...
                if (wz == 1) {
                    ...
                    var _e = this.ele.danmaku_warp.appendChild(dm);
            ...
            if (this.phone) {
                ...
                var ele = this.ele.video_con.childNodes;
