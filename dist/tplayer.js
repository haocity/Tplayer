            ...
            for (var _i2 = 0; _i2 < this.videosrcarr.length; _i2++) {
                ...
                if (this.options.video.type == "hls") {
                    if (Hls && Hls.isSupported()) {
                        ...
                        var hls = new Hls();
                        hls.loadSource(this.videosrcarr[_i2]);
    ...
    _createClass(Tplayer, [{
        ...
        value: function init() {
            ...
            this.send = function (text, color, wz, me, user, size) {
                ...
                if (wz == 1) {
                    ...
                    var twidth = dm.offsetWidth * this.config.danmakusize;
                    ...
                    if ((dmtop + 1) * this.dmheight * this.config.danmakusize < this.height) {
                        ...
                        this.nowdm.push({ time: inttime + leavetime.toFixed(1) * 10, call: function call() {
                    ...
                    var dtop = this.getcansendtop();
                    dm.style.top = dtop * this.dmheight + "px";
                    this.toparr[dtop] = 1;
                    var e = this.ele.danmaku_warp.appendChild(dm);
                    this.nowdm.push({ time: inttime + 50, call: function call() {
                    ...
                    (function () {
                        ...
                        if (tj.z) {
                            var _loop = function _loop(_i3) {
                                var a = _i3;
                                _this2.nowdm.push({ "call": function call() {
                    ...
                    if (_this.videoelearr[arg + 1]) {
                        ...
                        for (var _i11 = 0; _i11 < _this.videoelearr.length; _i11++) {
                            if (_i11 != _this.nowduan) {
                                var ele = _this.videoelearr[_i11];
            ...
            setInterval(function () {
                _this3.width = _this3.ele.tplayer_main.offsetWidth;
                _this3.height = _this3.ele.tplayer_main.offsetHeight;
                var videotime = _this3.getnowtime(videotime);
                //当前段播放将要结束 缓存下一段
                var temp = _this.videoelearr[_this3.nowduan].currentTime;
                if (temp + 20 >= _this.videotimearr[_this3.nowduan]) {
                    if (_this3.videoelearr[_this3.nowduan + 1]) {
                        if (_this3.videoelearr[_this3.nowduan + 1].preload != "auto") {
                            _this3.videoelearr[_this3.nowduan + 1].preload = "auto";
                            console.log("当前正在播放第" + _this3.nowduan + "段，正在加载下一段");
                        }
                    }
                }
                _this3.ele.nowtime.innerHTML = _this3.getvideotime(videotime).m + ":" + _this3.getvideotime(videotime).s;
            }, 1e3);
            ...
            this.ele.tplayer_main.addEventListener(screenChange, function () {
                _this3.joinfull();
            }, false);
            ...
            if (this.options.srollfixe && this.options.srollfixe > 0) {
                document.addEventListener('scroll', function () {
                    if ((document.documentElement.scrollTop || document.body.scrollTop) >= _this3.options.srollfixe) {
                        _this3.ele.tp_video_warp.className = 'tp-video-warp tp-video-warp-fixed';
                    } else {
                        _this3.ele.tp_video_warp.className = 'tp-video-warp';
                    }
                });
            }
        }
            ...
            xmlhttp.onreadystatechange = function () {
                if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                    ...
                    if (t.success == 1) {
                        ...
                        if (t.danmu) {
                            for (var _i13 = 0; _i13 < t.danmu.length; _i13++) {
                                t.danmu[_i13].text = unescape(t.danmu[_i13].text);
                                _this.data.push(t.danmu[_i13]);
                            }
                        }
                    }
                    _this.nowdata = _this.data.slice(0);
        ...
        value: function joinfull() {
            ...
            if (isfull) {
                ...
                this.dmspeend(this.width / 100);
                var _e = this.ele.danmaku_warp.getElementsByTagName("div");
                for (var _i14 = _e.length - 1; _i14 >= 0; _i14--) {
                    if (hasClass(_e[_i14], "tp-left")) {
                        _e[_i14].style.transform = "translateX(-" + this.width / this.config.danmakusize + "px)";
                    }
                }
                this.ele.video_ratio.ratio = 4;
                this.ele.video_ratio.click();
        ...
        value: function getallvideotime(ele, i) {
            ...
            if (!time) {
                ...
                if (this.videotimearr[0] && this.videotimearr[this.videotimearr.length - 1]) {
                    this.alltime = 0;
                    for (var _i15 = 0; _i15 < this.videotimearr.length; _i15++) {
                        this.alltime += this.videotimearr[_i15];
                    }
        ...
        value: function danmakutime() {
            ...
            if (this.nowdata) {
                var inttime = parseInt(videotime * 10);
                for (var _i16 = 0; _i16 < this.nowdata.length; _i16++) {
                    if (this.nowdata[_i16]) {
                        //console.log('nowtime:'+inttime);
                        if (this.nowdata[_i16].time == inttime) {
                            this.send(unescape(this.nowdata[_i16].text), this.nowdata[_i16].color, this.nowdata[_i16].place, false, this.nowdata[_i16].user, this.nowdata[_i16].size);
                            delete this.nowdata[_i16];
                        }
                    }
                }
                //弹幕定时器
        ...
        value: function tiao(time) {
            ...
            for (var _i17 = 0; _i17 < this.videoelearr.length; _i17++) {
                if (_i17 != this.nowduan) {
                    var ele = this.videoelearr[_i17];
                    ele.style.display = "none";
                    ele.currentTime = 0;
                    ele.pause();
                } else {
                    var _ele2 = this.videoelearr[_i17];
                    this.Element = _ele2;
            ...
            //      }
            for (var _i18 = 0; _i18 < this.nowdm.length; _i18++) {
                if (this.nowdm[_i18] && this.nowdm[_i18].call) {
                    this.nowdm[_i18].call();
                }
            }
        }
    }]);
